package com.epam.perkovdenys.task7.view;

import com.epam.perkovdenys.task7.dao.impl.CommandsDAOImpl;
...
public class Runner {
    ...
    public static void main(String[] args) throws IOException {
        ...
        startServers(compositeContainer);
        int input = -1;
    ...
    private static void startServers(CompositeContainer compositeContainer){
        new Server(ServerConstants.HTTP_PORT);
        new Server(ServerConstants.TCP_PORT);
    }
}
